...
campos_arquivos = {
"historico_decretos": ["Data", "Número", "Conteúdo"],
"historico_portarias_nomeacao": ["Data", "num_portaria", "tipo", "nome", "cargo", "cod_cargo", "orgao", "vaga_transferida", "vaga_decorrente", "gratificacoes"],
"historico_portarias_exoneracao": ["Data", "num_portaria", "tipo", "nome", "cargo", "cod_cargo", "orgao"],
"historico_portarias_insubsistentes": ["Data", "num_portaria", "portaria_insubsistente", "data_publicacao"],
"historico_portarias_corrigendas": ["Data", "num_portaria", "data_publicacao", "texto_anterior", "texto_corrigido"]
}
